...
public class AddCinemaActivity extends AppCompatActivity {
    ...
    List<String> listCinemasString = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listCinemasString = locationQuery.getLocationNames();
        arrayAdapter = new ArrayAdapter(this, R.layout.item_spinner, listCinemasString);
